...
insert into user (id, username, first_name, last_name, category, password) values ((select next_val from user_seq), 'rimi45', 'Rimi', 'Reza', 'DIRECTOR',
                                                                         '$2a$12$TMGmtfDansHZEtuYxamWjuhKCVxxg85pUSeeA7VB5mIzMFrcnzU46');
update user_seq set next_val=2;

insert into user (id, username, first_name, last_name, category, password) values ((select next_val from user_seq), 'rimi55', 'Rimii', 'Reza', 'EMPLOYEE',
                                                                         '$2a$12$TMGmtfDansHZEtuYxamWjuhKCVxxg85pUSeeA7VB5mIzMFrcnzU46');
